...
export const links = [
  {
    id: 1, // Dashboard Section
    title: "Dashboard",
    links: [
      {
        id: 101, // ecommerce link
        name: "ecommerce",
        icon: <FiShoppingBag />,
      },
    ],
...

  {
    ...
    links: [
      ...
      {
        id: 202, // employees link
        name: "employees",
        icon: <IoMdContacts />,
      },
      {
        id: 203, // customers link
        name: "customers",
        icon: <RiContactsLine />,
      },
    ],
...

  {
    ...
    links: [
      {
        id: 401, // line chart link
        name: "line",
        icon: <AiOutlineStock />,
      },
      {
        id: 402, // area chart link
        name: "area",
        icon: <AiOutlineAreaChart />,
      },
      {
        id: 403, // bar chart link
        name: "bar",
        icon: <AiOutlineBarChart />,
      },
      {
        id: 404, // pie chart link
        name: "pie",
        icon: <FiPieChart />,
      },
      {
        id: 405, // financial chart link
        name: "financial",
        icon: <RiStockLine />,
      },
      {
        id: 406, // color-mapping chart link
        name: "color-mapping",
        icon: <BsBarChart />,
      },
      {
        id: 407, // pyramid chart link
        name: "pyramid",
        icon: <GiLouvrePyramid />,
      },
      {
        id: 408, // stacked chart link
        name: "stacked",
        icon: <AiOutlineBarChart />,
      },
    ],
